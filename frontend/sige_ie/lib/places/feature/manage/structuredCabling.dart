...
class StructuredCablingScreen extends StatefulWidget {
  final String roomName;

  const StructuredCablingScreen({Key? key, required this.roomName})
      : super(key: key);

  @override
  _StructuredCablingScreenState createState() =>
      _StructuredCablingScreenState();
}

class _StructuredCablingScreenState extends State<StructuredCablingScreen> {
        ...
        child: Column(
          children: <Widget>[
            Container(
              ...
              child: Center(
                child: Text('${widget.roomName} - Cabeamento Estruturado',
